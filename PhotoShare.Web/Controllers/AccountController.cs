...
using PhotoShare.Sessions;
using PhotoShare.Web.Controllers.Results;
using PhotoShare.Web.Models;
using PhotoShare.Web.Models.Account;
...
{
    public class AccountController : PhotoShareControllerBase
    {
